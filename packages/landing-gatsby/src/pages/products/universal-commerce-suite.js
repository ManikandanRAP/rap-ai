...
import InfoProductSection from '../../containers/Hosting/InfoProduct';
import Ctasection from '../../containers/Hosting/Ctasection';

const UniversalComSuitePage = () => {
  return (
    <ThemeProvider theme={hostingTheme}>
      <ParallaxProvider>
        ...
        <ResetCSS />
        <GlobalStyle />
        <ContentWrapper className="UniversalCom_suite_page">
...
export default UniversalComSuitePage;
