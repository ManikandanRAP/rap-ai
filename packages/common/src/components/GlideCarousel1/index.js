...
const GlideCarousel1 = ({
  ...
  useEffect(() => {
    const glide = new Glide(
      carouselSelector ? `#${carouselSelector}` : '#glide3',
      {
        ...options,
      }
    );
...
GlideCarousel1.propTypes = {
  /** className of the GlideCarousel1. */
...
// GlideCarousel1 default props
GlideCarousel1.defaultProps = {
  controls: true,
  bullets: false,
};

export default GlideCarousel1;
