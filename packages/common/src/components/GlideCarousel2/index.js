...
const GlideCarousel2 = ({
  ...
  useEffect(() => {
    const glide = new Glide(
      carouselSelector ? `#${carouselSelector}` : '#glide2',
      {
        ...options,
      }
    );
...
GlideCarousel2.propTypes = {
  /** className of the GlideCarousel2. */
...
// GlideCarousel2 default props
GlideCarousel2.defaultProps = {
  controls: true,
  bullets: false,
};

export default GlideCarousel2;
